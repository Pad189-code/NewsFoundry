    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-6 text-slate-900">
      <main className="w-full max-w-2xl rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/login"
            className="rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-[#898989] hover:bg-slate-700"
          >
            Se connecter
          </Link>
          <Link
            href="/chats"
            className="rounded-md border border-slate-300 px-4 py-2 text-sm font-medium text-[#898989] hover:bg-slate-100"
          >
